 ...
 */ 
    ...
    Write1DArrayVsE(h_E_glo_data, h_T_loc_data, "output/Transmission", "E   T_r   T_i");
    Write1DArrayVsE(h_E_glo_data, h_DOS_loc_data, "output/DOS", "E  DOS_r  DOS_i");
...
int main (int argc, char* argv[])
{
    ...
    Write2DArrayVsE(h_E_glo_data, h_Sigma_glo_data, "output/Sigma", "E Sigma_s_r Sigma_s_i Sigma_d_r Sigma_d_i");
