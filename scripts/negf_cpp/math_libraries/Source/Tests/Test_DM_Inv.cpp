...
void Test_DM_Inv::Print_Input() { Print_Table2D(h_A_data, "A"); }

void Test_DM_Inv::Perform_Test()
{
...
void Test_DM_Inv::Generate_Answer()
{
...
void Test_DM_Inv::Print_Answer()
{
    Print_Table2D(h_ANS_data, "ANS = A * Ainv");
}

void Test_DM_Inv::Copy_Soln_To_Host()
{
...
void Test_DM_Inv::Verify(bool flag_print_answer)
{
    if (!output_copied_to_host) Copy_Soln_To_Host();
