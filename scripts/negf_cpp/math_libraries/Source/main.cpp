...
std::unordered_map<Test, bool> flag_map{{Test::MM_Mul, true},
                                        {Test::DM_Inv, true},
                                        {Test::ConjT, true},
                                        {Test::DM_Eig, true}};
...
int main(int argc, char* argv[])
{
...

    {
        ...
        if (flag_map[Test::MM_Mul])
        {
            ...
            Test_MathLibrary<Test_MM_Mul> mm_mul(Test_MM_Mul(A_rows, A_cols,
                                                             B_cols),
                                                 print_flags);
        ...
        if (flag_map[Test::DM_Inv])
        {
            ...
            Test_MathLibrary<Test_DM_Inv> dm_inv(Test_DM_Inv(A_rows, A_cols),
                                                 print_flags);
        ...
        if (flag_map[Test::ConjT])
        {
            ...
            amrex::Print() << "A_rows/cols: " << A_rows << " " << A_cols
                           << "\n";
            Test_MathLibrary<Test_ConjT> conjT(Test_ConjT(A_rows, A_cols),
                                               print_flags);
