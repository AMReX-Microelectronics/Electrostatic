...
std::string Msg(const std::string &msg, const std::string &msg_prefix,
                const std::string &msg_line_prefix, const int msg_line_length,
                const bool do_text_wrapping)
{
    ...
    const auto wrapped_text =
        ablastr::utils::automatic_text_wrap(msg, msg_line_length);
...
std::string ablastr::utils::TextMsg::Err(const std::string &msg,
                                         const bool do_text_wrapping)
{
    return ::Msg(msg, ::err_prefix, ::err_line_prefix, ::line_length,
                 do_text_wrapping);
}
...
std::string ablastr::utils::TextMsg::Info(const std::string &msg,
                                          const bool do_text_wrapping)
{
    return ::Msg(msg, ::info_prefix, ::line_prefix, ::line_length,
                 do_text_wrapping);
}
...
std::string ablastr::utils::TextMsg::Warn(const std::string &msg,
                                          const bool do_text_wrapping)
{
    return ::Msg(msg, ::warn_prefix, ::line_prefix, ::line_length,
                 do_text_wrapping);
}

void ablastr::utils::TextMsg::Assert(const char *ex, const char *file,
...
std::vector<std::string> ablastr::utils::automatic_text_wrap(
