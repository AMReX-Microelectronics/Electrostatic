...
void WarnManager::record_warning(std::string topic, std::string text,
                                 Priority priority)
{
...
std::string WarnManager::get_header(const std::string &when,
                                    const int line_size,
    ...
    const MsgLogger::MsgWithCounter &msg_with_counter) const
{
    ...
    ss << msg_formatter(msg_with_counter.msg.text, warn_line_size,
                        warn_tab_size);
...
std::string WarnManager::msg_formatter(const std::string &msg,
                                       const int line_size,
