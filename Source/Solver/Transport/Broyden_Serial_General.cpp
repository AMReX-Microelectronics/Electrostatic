...
void c_TransportSolver::Set_Broyden()
{
    ...
    amrex::Print() << "Number of field_sites at all nanostructures, "
    ...
    if (ParallelDescriptor::IOProcessor())
    {
        ...
        h_n_curr_in_data.resize({0}, {num_field_sites_all_NS},
                                The_Pinned_Arena());
        h_n_curr_out_data.resize({0}, {num_field_sites_all_NS},
                                 The_Pinned_Arena());
        h_n_start_in_data.resize({0}, {num_field_sites_all_NS},
                                 The_Pinned_Arena());
        h_n_prev_in_data.resize({0}, {num_field_sites_all_NS},
                                The_Pinned_Arena());
        ...
        h_delta_F_curr_data.resize({0}, {num_field_sites_all_NS},
                                   The_Pinned_Arena());
        h_delta_n_curr_data.resize({0}, {num_field_sites_all_NS},
                                   The_Pinned_Arena());
        ...
        switch (map_AlgorithmType[Algorithm_Type])
        {
            case s_Algorithm::Type::broyden_first:
            {
                ...
                if (flag_initialize_inverse_jacobian)
                {
                    ...
                    Read_Table2D(assert_size, h_Jinv_curr_data,
        ...
        // amrex::Print() << " Broyden_Correction_Step: "               <<
        // Broyden_Correction_Step               << "\n"; amrex::Print() << "
        // Broyden_NormSumIsIncreasing_Step: "      <<
        // Broyden_NormSumIsIncreasing_Step      << "\n"; amrex::Print() << "
        // Broyden_Reset_Step: "                    << Broyden_Reset_Step <<
        // "\n";
        ...
        // amrex::Print() << " Broyden_Threshold_NormSumIncreaseStep: " <<
        // Broyden_Threshold_NormSumIncreaseStep << "\n"; amrex::Print() << "
        // Broyden_Threshold_CorrectionStep: "      <<
        // Broyden_Threshold_CorrectionStep      << "\n"; amrex::Print() << "
        // Broyden_Threshold_MinFraction: "         <<
        // Broyden_Threshold_MinFraction         << "\n"; amrex::Print() << "
        // Broyden_Fraction_Decrease_Factor: "      <<
        // Broyden_Fraction_Decrease_Factor      << "\n"; amrex::Print() << "
        // Broyden_Scalar_Decrease_Factor: "        <<
        // Broyden_Scalar_Decrease_Factor        << "\n\n";
    }
}

void c_TransportSolver::Reset_Broyden()
{
...
//         "\n\n\n\n**********************************Restarting
//         Broyden**********************************\n"; int size =
//         W_Broyden.size(); for(int j=0; j<size; ++j)
//         {
//             W_Broyden[j]->clear();
//             V_Broyden[j]->clear();
//         }
//         W_Broyden.clear();
//         V_Broyden.clear();
//         amrex::Print() << " W&V sizes before/after: " << size << ", "<<
//         W_Broyden.size() << "\n";
//
//         SetVal_RealTable1D(h_n_curr_out_data, 0.);
//         SetVal_RealTable1D(h_n_prev_in_data, 0.);
...
//         Broyden_fraction =
//         Broyden_Original_Fraction/std::pow(Broyden_Fraction_Decrease_Factor,Broyden_Reset_Step);
//
//         if(Broyden_fraction < Broyden_Threshold_MinFraction)
//         {
//             amrex::Print() << "*Broyden_fraction is less than the threshold:
//             " << Broyden_Threshold_MinFraction << "\n"; amrex::Print() <<
//             "*Charge density is reset to: " << NS_initial_deposit_value <<
//             "\n";
//
//             Broyden_fraction = Broyden_Original_Fraction;
//             Broyden_Reset_Step = 0;
...
//         Broyden_NormSumIsIncreasing_Step << "\n"; amrex::Print() << "
//         Broyden_Reset_Step: "       << Broyden_Reset_Step << "\n";
//         amrex::Print() << " Broyden_NormSum_Curr: "     <<
//         Broyden_NormSum_Curr << "\n"; amrex::Print() << "
//         Broyden_NormSum_Prev: "     << Broyden_NormSum_Prev << "\n";
//         amrex::Print() << " Broyden_Max_Norm: "         << Broyden_Norm <<
//         "\n\n";
//
//     }
...
void c_TransportSolver::Deallocate_Broyden_Serial()
{
    if (ParallelDescriptor::IOProcessor())
    {
