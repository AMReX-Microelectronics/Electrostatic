...
void MaterialProperties::ReadParameters()
{
    ParmParse pp;
...
MacroscopicProperties::InitData ()
{
    ...
    m_eps_mf = std::make_unique<amrex::MultiFab>(ba, dm, Ncomp1, Nghost1); 
...
void
MaterialProperties::InitializeMacroMultiFabUsingParser (
